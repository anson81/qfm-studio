...
def _build_allowed_origins():
    """Build allowed origins list with dynamic .qfmstudio.com support."""
    static = os.environ.get("ALLOWED_ORIGINS", "http://localhost:5173,http://localhost:3000,http://localhost:8000,https://anson81.github.io").split(",")
    # Always include all qfmstudio.com subdomains
    dynamic = [
        "https://qfmstudio.com",
        "https://www.qfmstudio.com",
        "https://api.qfmstudio.com",
    ]
